...
from Midi.helperFunctions import mse_with_positive_pressure
import tensorflow as tf
from Midi.modelAPI import MusicRNN
import pathlib
import glob
...
def generateUsingMIDIModel():
    global temperature
    model = tf.keras.saving.load_model('Midi/models/tuner_best_mode.keras')
